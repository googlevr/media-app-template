...
namespace DaydreamElements.Common {
  ...
  [ExecuteInEditMode]
  public class GlobalDynamicWindColor : MonoBehaviour {
    ...
    //public float worldYWindFalloff = 0.5f;
    //public float worldGroundYPos = 0f;
    ...
    public DynamicWindColorEffector effectorB;
    public DynamicWindColorEffector effectorC;
    ...
    //int worldYWindFalloffID;
    //int worldGroundYPosID;
    ...
    void OnDrawGizmos() {
      ...
      effectorB.DrawGizmos();
      effectorC.DrawGizmos();
    }
    ...
    void Awake() {
      ...
      //worldYWindFalloffID = Shader.PropertyToID("_WorldYWindFalloff");
      //worldGroundYPosID = Shader.PropertyToID("_WorldGroundYPos");
      
      effectorAID = Shader.PropertyToID("_EffectorA");
      effectorBID = Shader.PropertyToID("_EffectorB");
      effectorCID = Shader.PropertyToID("_EffectorC");
    }
    ...
    void Start() {
      ...
      effectorB.UpdateEffector();
      effectorC.UpdateEffector(); 
    ...
    void Initialize() {
      ...
      effectorB.Initialize();
      effectorC.Initialize();
    }
    ...
    void SetGlobalShaderParams() {
      ...
      //Shader.SetGlobalFloat(worldYWindFalloffID, worldYWindFalloff);
      //Shader.SetGlobalFloat(worldGroundYPosID, worldGroundYPos);

      Shader.SetGlobalVector(effectorAID, effectorA.effectorProperties);
      Shader.SetGlobalVector(effectorBID, effectorB.effectorProperties);
      Shader.SetGlobalVector(effectorCID, effectorC.effectorProperties);
    }
    ...
    void UpdateResponders() {
      for (int i=0; i<responderCount; i++) {
        ...
        Responders[i].ActivateFromEffector(effectorB.effectorProperties);
        Responders[i].ActivateFromEffector(effectorC.effectorProperties);
      }
    }
  }
}
