...
Shader "GoogleVR/Demos/Daydream Elements/Rimlight Vertex Color Alpha Detail Texture"
{
	Properties 
	{
  ...
  SubShader 
  {
      ...
      #include "UnityCG.cginc"
        ...
        float3 viewDir = normalize(ObjSpaceViewDir(v.vertex));
		    ...
		    half rim = (smoothstep(1 - _RimBias, 1.0, NDotV)) * (v.color).a;
  		  ...
  		  o.color = lerp(v.color, _RimColor, rim);
